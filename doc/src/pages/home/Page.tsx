        ...
        <BaseLayout {...props}>
            ...
            <main class={page['main-container']}>
                <div class={page['entry']}>
                    ...
                    <p class={page['text']}>
                        By default Frugal only produces static html at build time, working like a
                        static site generator. Even if you use a client-side UI framework like{' '}
                        <a
                ...
                <div class={page['entry']}>
                    ...
                    <p class={page['text']}>
                        Frugal comes with a server that can render dynamic pages at request time.
                        Pages can answer to GET, POST, PUT and DELETE with fully controlable
                ...
                <div class={page['entry']}>
                    ...
                    <p class={page['text']}>
                        If you declare islands of interactivity with client-side UI framework,
                        Frugal will bundle the js necessary to hydrate them while still rendering
                        the static html of those islands. Clients that can run those bundle get an
                        enhanced experience, others still get a functional html page.
                    </p>
                </div>
                ...
                <div class={page['entry']}>
                    ...
                    <p class={page['text']}>
                        Frugal works with any UI framework able to compile to html for static
                        content. You can declare islands of interactivity with{' '}
                        <a
                            class={clsx(link['link'])}
                            href='https://preactjs.com/'
                        >
                ...
                <div class={page['entry']}>
                    ...
                    <p class={page['text']}>
                        As long as you persist some cache data, Frugal will ever rebuild pages on
                        two conditions : either the data or the code for the page has changed since
                        the last build
                    </p>
                </div>
                ...
                <div class={page['entry']}>
                    ...
                    <p class={page['text']}>
                        Instead of building a SPA and having to send the whole application to the
                        client, reimplement routing, caching, etc... with Frugal and client session
                        you build a MPA and you get an SPA experience : the client js context is
