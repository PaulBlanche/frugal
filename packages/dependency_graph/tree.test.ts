...
type PartialModule = Partial<Omit<tree.Module, 'dependencies'> & { dependencies: PartialModule[] }>;
type PartialRoot = Partial<Omit<tree.Root, 'dependencies'> & { dependencies: PartialModule[] }>;
