//TODO(@PaulBlanche): maybe use prismjs and marked directly ?
export * from 'https://deno.land/x/gfm@0.1.20/mod.ts';
...
import 'https://esm.sh/prismjs@1.27.0/components/prism-json.js?no-check';
