...
import { FOOTER_CLASSNAME } from '../BaseLayout/Footer.tsx';
import {
    navigationContainer,
    navigationWithButton,
} from '../BaseLayout/Navigation.style.ts';
import { NAVIGATION_CLASS } from '../BaseLayout/Navigation.tsx';
...
export class Toggler {
    ...
    onOpen() {
        ...
        console.log('add drawerOpen');
        console.log('remove drawerClose');
    ...
    onClose() {
        ...
        console.log('remove drawerOpen');
        console.log('add drawerClose');
