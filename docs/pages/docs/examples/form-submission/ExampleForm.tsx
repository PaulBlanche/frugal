            ...
            >
                ...
                <div class={cx(s.field)}>
                    ...
                    <input
                        ...
                        type='text'
                        name='csrftoken'
                        value={String(form.field('csrftoken').value)}
                        onInput={(event) => {
                            form.field('csrftoken').value =
                                event.currentTarget.value;
                        }}
                        onBlur={() => {
                            form.field('csrftoken').touch();
                        }}
                    />
                </div>
