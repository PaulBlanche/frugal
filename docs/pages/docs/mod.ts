...
import { Data, PATTERN } from './type.ts';
...
export function getPathList(): frugal.PathList<typeof PATTERN> {
...
export const getContent = getContentFrom<Data, typeof PATTERN>(Page);
